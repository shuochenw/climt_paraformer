...
netcdf_monitor = NetCDFMonitor('gcm_without_seasonal_cycle.nc',write_on_store=True,store_names=fields_to_store)
...
diag['convective_downdraft_specific_humidity_scale']
...
import xarray as xr
a=xr.open_dataset('/projects/sds-lab/Shuochen/climt/64x32_TOA.nc')
...
a.air_temperature.isel(time=-1).sel(lat=30,lon=60).plot()
